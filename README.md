...
It's time to set a conditional breakpoint. Since we want to trace back which function called the encryption function for the gold, we will use "Break and trace instruction". This will trace the next X instructions after our breakpoint has been reached and display them in a window.<br>
