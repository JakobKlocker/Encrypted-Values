...
# Intro
Most games these days will encrypt important values such as player informations & enemy informations to make it harder to find the addresses and edit/work with it's conent.<br>
...
<br>We will be doing the second approach today, the first approach will be covered in a later post.
